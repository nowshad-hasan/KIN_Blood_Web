<%-- 
    ...
    Created on : Jan 29, 2018, 2:41:37 PM
    Author     : nowshad
--%>
...
<html>
    ...
    <body>
        ...
        <div class="color_header">
            <h3 class="color_header_text">ADD NEW USER</h3>
        </div>

        <div class="container">
            <h2>Horizontal form</h2>
            <form class="form-horizontal" action="AddNewUserServlet" method="post">

                <div class="form-group">
                    <label class="control-label col-sm-2" >User Name:</label>
                    <div class="col-sm-10">
                        <input required type="text" class="form-control" id="email" placeholder="Enter email" name="userName">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input required type="email" class="form-control" id="email" placeholder="Enter email" name="userEmail">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="pwd">User Password:</label>
                    <div class="col-sm-10">          
                        <input required type="password" class="form-control" id="pwd" placeholder="Enter password" name="userPass">
                    </div>
                </div>
                <div class="form-group">        
