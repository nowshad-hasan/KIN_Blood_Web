<%-- 
    Document   : all_donor
    Created on : Jan 2, 2018, 3:22:41 PM
    Author     : nowshad
--%>
...
<html>
    ...
    <body>
        ...
        <div class="color_header">
            <h3 class="color_header_text">ALL DONOR</h3>
        </div>

        <br>
        <br>
        <div class="container">
            <form action="AllDonorServlet" method="post">
            ...
            <c:otherwise>
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <table id="allDonor" class="table table-bordered">
                        ...
                        <tbody>
                            <c:forEach items="${allDonor}" var="Donor">
                                <tr class="info">
                                    <th scope="row"><%=++i%></th>
