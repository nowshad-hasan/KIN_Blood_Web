<%-- 
    Document   : available_donor
    Created on : Jan 2, 2018, 3:21:49 PM
    Author     : nowshad
--%>
...
<html>
    ...
    <body>
        ...
        <div class="color_header">
            <h3 class="color_header_text">Available Donor</h3>
        </div>
        <br>
        <br>
        <div class="container">
...
<!--                    <h3 >Available Donor</h3>-->
                    <table id="availableDonor" class="table table-bordered">
                        <caption style="color:black" >Available Donor's Table</caption>
