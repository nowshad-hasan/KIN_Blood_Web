<%-- 
    Document   : unavailable_donor
    Created on : Jan 2, 2018, 3:22:18 PM
    Author     : nowshad
--%>
...
<html>
    ...
    <body>
        ...
        <div class="color_header">
            <h3 class="color_header_text">Unavailable Donor</h3>
        </div>

        <br>
        <br>
        <div class="container">
            <form action="UnavailableDonorServlet" method="post">
        ...
        <c:choose>
            <c:when test="${empty unavailableDonor}">
                <div class="container">
            ...
            <c:otherwise>
                ...
                <div class="col-md-10 col-md-offset-1">
                    <h3 >Unavailable Donor</h3>
                    <table id="availableDonor" class="table table-bordered">
                      <caption style="color:black" >Unavailable Donor's Table</caption>
                        ...
                        <tbody>
                            <c:forEach items="${unavailableDonor}" var="Donor">
                                <tr class="info">
                                    <th scope="row"><%=++i%></th>
